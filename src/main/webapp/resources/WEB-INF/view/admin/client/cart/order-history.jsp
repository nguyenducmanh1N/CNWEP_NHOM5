                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <c:if test="${order.status.name == 'Delivered'}">
                                                        <!-- <a href="/review/show/${orderDetail.product.id}" class="btn btn-primary mt-4">Review</a> -->
                                                        <a href="/product/review/${orderDetail.product.id}" class="btn btn-primary mt-4">Review</a>
                                                    </c:if>
                                                </td>
                                                <td></td>
