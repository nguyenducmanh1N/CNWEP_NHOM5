                                ...
                                <div class="mt-5 row g-4 justify-content-start">
                                    <div class="col-12 col-md-8">
                                        <div class="bg-light rounded">
                                            ...
                                            <!-- <div class="mt-4">
                                                <h5 class="mb-0 ps-4 me-4">Nhập mã voucher</h5>
                                                <div class="mb-0 ps-4 input-group">
                                                    <input type="text" class="form-control" id="voucherCode" placeholder="Nhập mã voucher">
                                                    <button class="btn btn-primary" type="button" id="applyVoucher">Sử dụng</button>
                                                </div>
                                            </div>
                                            ...
                                            <script type="text/javascript">
                                                document.getElementById("applyVoucher").addEventListener("click", function () {
                                                    ...
                                                    if (voucherCode) {
                                                        // Gửi mã voucher đến server để kiểm tra và tính toán
                                                        $.ajax({
                                                            url: '/apply-voucher',
                                                            type: 'POST',
                                                            data: {
                                                            ...
                                                            success: function (response) {
                                                                if (response.valid) {
                                                                    // Cập nhật tổng số tiền phải trả
                                                                    document.querySelector("[data-cart-total-price]").innerText = response.totalPayable + ' đ';
                                                                } else {
